    ...
    return(
        ...
        <div className="container d-flex align-items-center justify-content-between">
           ...
           <div className="main-nav d-none d-lg-flex">
              <button className="navbar-toggler mobile-nav-toggle border-0 p-0 d-lg-none mobileMenuClose" type="button"
                 data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
                 aria-expanded="false" aria-label="Toggle navigation">
                 <img src="image/close.png" alt="" />
                 </button>
              <ul className=" d-lg-flex align-items-lg-center float-lg-left">
                 <li className=""><Link className="scrollLink active" href="/">Home</Link></li>
                 <li className=""><Link className="scrollLink" href="/about">About</Link></li>
  
                 <li className=""><Link className="scrollLink" href="/products">
                       Products
                    </Link>
                 </li>
                 <li className=""><Link className="scrollLink" href="contact">
                       Contact
                    </Link>
                 </li>
              </ul>
