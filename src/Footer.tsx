      ...
      <div className="container">
        <div className="row footerSection defaultPaddingTB">
          <div className="col-xl-5 col-lg-6">
            ...
            <p className="mb-3">
              Samridhi Frames empower you to embark on a journey of prosperity
              and growth. These exquisite frames serve as constant reminders of
              your limitless potential, igniting the spark of confidence within
              you. All rights reserved. J2D FASHIONS PRIVATE LIMITED
            </p>
        ...
        <div className="row py-3 border-top footerBottom">
          <div className="col-xl-12 col-lg-12">
            <p className="text-center text-lg-start">
              Copyright ©2023 J2D FASHIONS PRIVATE LIMITED. All rights reserved.
            </p>
          </div>
