                    ...
                    <div
                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide text-center">
                                <img
                                    src={productDetail?.full_image_path} alt="product image"/>
                            </div>
                            {/* <div className="swiper-slide text-center">
                                <img
                            ...
                            <div className="swiper-slide">
                                <div className="productSmalSlider">
                                    <div>
                                        <img
                                            src={productDetail?.full_image_path} alt="product image" />
                                        <h6 className="text-center mt-2">{productDetail?.product_name}</h6>
                                    </div>
                                </div>
                            </div>
                            {/* <div className="swiper-slide">
                ...
                <div className="col-lg-6">
                    ...
                    <div className="productDetails">
                        <div className="d-flex align-items-center mt-3">
                            <h3 className="yellow-color KumbhSans-Bold">Rs {productDetail?.discount_price}</h3>
                            <h3 className="mx-3 KumbhSans-Bold"><del>Rs {productDetail?.price}</del></h3>
                            <h6 className="">( {productDetail?.discount_percentage}% OFF )</h6>
                        </div>
                        <div className="mt-3">
