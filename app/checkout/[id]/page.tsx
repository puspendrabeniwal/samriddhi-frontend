  ...
  async function handleSubmit(
    ...
    try {
      ...
      const response = await axios.post(
        `${AppConstants.Api_BaseUrl}/checkout/${params.id}`,
        values
      );
            ...
            <Formik
              ...
              validate={(values) => {
                ...
                if (!values.address_line_1)
                  errors.address_line_1 = "Address cannot be blank";
                if (!values.address_line_2)
                  errors.address_line_2 = "Address cannot be blank";
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row">
                    <div className="col-lg-8">
                      ...
                      <h1 className="billingHeading mt-5">
                    ...
                    <div className="col-lg-4 ">
                      <div className="OrderSummary">
                        ...
                        <ul className="list-unstyled">
                          <li>
                            Base Total{" "}
                            <span>₹ {productDetail?.discount_price}</span>
                          </li>
                          <li>
